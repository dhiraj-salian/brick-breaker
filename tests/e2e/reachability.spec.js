 ...
 *
 * NOTE: As of v0.5.1, the app boots to #auth-screen. These tests use the
 * "Continue as Guest" flow to reach the menu before interacting with the game.
 */
...
test('game runs without console errors', async ({ page }) => {
  ...
  // Skip auth screen via guest mode
